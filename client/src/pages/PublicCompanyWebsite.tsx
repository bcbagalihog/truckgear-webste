...
import { 
  Truck, Zap, Layers, MapPin, ExternalLink, 
  Coins, Recycle, Sparkles, AlertTriangle, ArrowRight,
  Quote, Eye, Target, MessageCircle
} from 'lucide-react';

export default function PublicCompanyWebsite() {
  ...
  return (
    <div className="bg-slate-950 text-slate-100 min-h-screen font-sans selection:bg-yellow-400 selection:text-slate-950">
          ...
          <div className="flex items-center gap-3 select-none">
            ...
            <div className="flex flex-col select-none">
              <span className="font-black italic text-xl tracking-wide text-white leading-none">
                Truck<span className="text-yellow-400 glow-text-yellow">Gear</span>
              </span>
              <span className="text-[9px] font-mono text-yellow-400 uppercase tracking-widest leading-none mt-1">PHILIPPINES CO.</span>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-8 text-xs font-bold text-slate-400 uppercase tracking-widest">
            <Link href="/catalog" className="hover:text-yellow-400 transition-colors">Catalog</Link>
            <a href="#about" className="hover:text-yellow-400 transition-colors">About</a>
            <a href="#vision" className="hover:text-yellow-400 transition-colors">Vision & Mission</a>
            <a href="#parts" className="hover:text-yellow-400 transition-colors">Parts Grid</a>
            <a href="#batteries" className="hover:text-yellow-400 transition-colors">Batteries</a>
            <a href="#ceo" className="hover:text-yellow-400 transition-colors">CEO Message</a>
          </nav>
          <div>
            <Link 
              href="/portal/login" 
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-yellow-400 hover:bg-yellow-300 text-slate-950 font-bold text-xs rounded-md shadow-lg shadow-yellow-400/10 hover:shadow-yellow-400/30 transition-all duration-300 group uppercase tracking-widest"
            >
      ...
      <section className="relative relative-grid py-20 md:py-28 border-b border-slate-900 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="absolute top-0 right-0 w-[45%] h-full bg-gradient-to-br from-yellow-500/10 to-transparent pointer-events-none transform skew-x-12 z-0 hidden lg:block border-l border-yellow-500/10"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-yellow-400/10 text-yellow-400 text-[10px] font-black uppercase tracking-widest rounded-full border border-yellow-400/20">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-white leading-[1.05] uppercase">
                ...
                <span className="text-yellow-400 glow-text-yellow">YOUR PARTNER IN SUCCESS.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link href="/catalog" className="px-8 py-4 bg-yellow-400 text-slate-950 hover:bg-yellow-300 font-bold text-xs uppercase tracking-widest rounded-lg transition-all duration-300 text-center shadow-xl shadow-yellow-400/15 hover:shadow-yellow-400/35 flex items-center justify-center gap-2">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative w-full aspect-square max-w-[420px] mx-auto rounded-3xl overflow-hidden border-2 border-yellow-400/35 shadow-2xl shadow-yellow-400/10 group">
                <div className="absolute top-0 left-0 w-12 h-12 border-t-4 border-l-4 border-yellow-400 z-20"></div>
                <div className="absolute bottom-0 right-0 w-12 h-12 border-b-4 border-r-4 border-yellow-400 z-20"></div>
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-slate-950/80 backdrop-blur-md p-3.5 rounded-xl border border-slate-800 z-10 flex justify-between items-center text-[10px] font-mono select-none">
                  ...
                  <span className="text-yellow-400 font-bold">NITRO-5 DEVICE CONNECTED</span>
                </div>
              </div>
            </div>
      ...
      <section id="about" className="py-24 max-w-7xl mx-auto px-6 scroll-mt-20">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block border-l-2 border-yellow-400 pl-3">SECTION 01 // OVERVIEW</span>
            <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight leading-none">About Company</h2>
            
            <p className="text-slate-400 leading-relaxed font-medium">
              Founded in 2016 in the industrial center of Caloocan, <strong className="text-slate-200">TruckGear Philippines Co.</strong> began with a singular mission: to serve as a reliable supplier of Japanese and Chinese truck parts.
            </p>
            <p className="text-slate-400 leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="p-4 bg-slate-900/40 border border-slate-800 rounded-xl">
                <span className="text-2xl font-black text-yellow-400 font-mono block">24 Hrs</span>
              ...
              <div className="p-4 bg-slate-900/40 border border-slate-800 rounded-xl">
                <span className="text-2xl font-black text-yellow-400 font-mono block">25,000+</span>
          ...
          <div className="lg:col-span-6 space-y-6 bg-slate-900/30 border border-slate-800 p-8 rounded-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-yellow-400/[0.03] rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4 group">
                  <div className="w-8 h-8 rounded-md bg-yellow-400/10 text-yellow-400 flex items-center justify-center font-mono font-bold text-xs shrink-0 group-hover:bg-yellow-400 group-hover:text-slate-950 transition-colors duration-300">
                    0{i+1}
                  </div>
                  <div>
      ...
      <section id="vision" className="bg-slate-900/20 border-y border-slate-900 py-24 scroll-mt-20 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-64 h-full bg-yellow-400/5 transform -skew-x-12 -translate-x-32 pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 w-64 h-full bg-yellow-400/5 transform skew-x-12 translate-x-32 pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-xl mx-auto mb-16 space-y-2">
            <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block">SECTION 02 // ROADMAP</span>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            {/* Vision Panel */}
            <div className="bg-slate-900/60 border border-slate-800 hover:border-yellow-400/20 rounded-2xl p-8 space-y-6 transition-all duration-300 group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-16 h-16 bg-yellow-400/5 rounded-bl-3xl pointer-events-none"></div>
              <div className="w-12 h-12 bg-yellow-400/10 text-yellow-400 rounded-xl flex items-center justify-center group-hover:bg-yellow-400 group-hover:text-slate-950 transition-colors duration-300">
      ...
      <section id="parts" className="py-24 max-w-7xl mx-auto px-6 scroll-mt-20">
        <div className="text-center max-w-xl mx-auto mb-16 space-y-2">
          <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block">RETAIL DIVISION // AFTERMARKET SPECIALISTS</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-slate-900/40 border border-slate-800 hover:border-yellow-400/20 p-6 rounded-2xl shadow-md transition-all duration-300 relative group">
              <div className="absolute top-0 right-0 w-8 h-8 border-t border-r border-slate-800 group-hover:border-yellow-400/30 transition-colors rounded-tr-2xl"></div>
              <div className="w-10 h-10 bg-yellow-400/5 text-yellow-400 rounded-lg flex items-center justify-center mb-4 group-hover:bg-yellow-400 group-hover:text-slate-950 transition-colors duration-300">
                <part.icon className="w-5 h-5" />
              </div>
              <span className="text-[10px] text-yellow-400 font-mono tracking-widest uppercase block mb-1">{part.category}</span>
      ...
      <section id="batteries" className="bg-slate-900/20 border-t border-slate-900 py-24 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block">TRUCKGEAR PHILIPPINES CO.</span>
              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="space-y-1.5">
                  ...
                  <select 
                    ...
                    className="w-full p-3 bg-slate-950 border border-slate-800 rounded-lg text-slate-100 focus:outline-none focus:border-yellow-400 font-mono"
                  >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      className="w-full p-3 bg-slate-950 border border-slate-800 rounded-lg text-slate-100 text-center focus:outline-none focus:border-yellow-400 font-mono font-bold"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <button
                      ...
                      className={`w-full p-3 border rounded-lg text-center font-bold transition-all duration-300 font-mono uppercase tracking-widest ${isTradeIn ? 'bg-yellow-400/10 border-yellow-400 text-yellow-400' : 'bg-slate-950 border-slate-800 text-slate-500'}`}
                    >
                ...
                <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2.5 font-mono text-[11px] select-none shadow-inner">
                  ...
                  <div className="flex justify-between text-base font-bold text-yellow-400 pt-1">
          ...
          <div className="border-t border-slate-800 pt-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { step: '01', name: 'GET NEW POWER', icon: Zap, color: 'text-yellow-400', desc: 'Equip your truck fleet with MEDEX storage batteries. Guaranteed direct wholesale pricing and extended warranties.' },
                ...
                <div key={i} className="bg-slate-900/30 border border-slate-800 p-6 rounded-xl space-y-4">
      ...
      <section id="ceo" className="py-24 max-w-7xl mx-auto px-6 scroll-mt-20">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block border-l-2 border-yellow-400 pl-3">SECTION 03 // LEADERSHIP MESSAGE</span>
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="p-4 bg-slate-900/60 border border-slate-800 rounded-2xl space-y-4 shadow-xl">
              ...
              <div className="relative aspect-[3/4] w-full rounded-lg overflow-hidden border border-slate-800 group">
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex flex-col justify-end p-4 text-left space-y-1.5 font-mono select-none">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="px-2 py-0.5 bg-yellow-400/10 border border-yellow-400/20 text-yellow-400 text-[8px] rounded uppercase font-bold tracking-widest">LATEST RELEASE</span>
                  </div>
                </div>
              </div>
      ...
      <section id="milestones" className="bg-slate-900/10 border-t border-slate-900 py-24 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-20 space-y-2">
            <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block">SECTION 04 // TIMELINE</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-slate-900/40 hover:bg-slate-900 border border-slate-800 hover:border-yellow-400/30 p-8 rounded-2xl flex flex-col justify-between relative transition-all duration-300 group shadow-lg hover:shadow-yellow-400/[0.02]">
                <div className="absolute top-0 right-0 w-8 h-8 border-t border-r border-slate-800 group-hover:border-yellow-400/20 rounded-tr-2xl transition-colors"></div>
                <div className="absolute top-0 left-0 w-[4px] h-0 bg-yellow-400 rounded-l-2xl group-hover:h-full transition-all duration-300"></div>
                
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-3xl font-black text-yellow-400 block font-mono leading-none tracking-tighter">{mile.year}</span>
                ...
                <div className="mt-8 pt-4 border-t border-slate-800 flex items-center gap-1.5 text-xs text-slate-300">
      ...
      <section id="brands" className="bg-slate-900/40 border-t border-slate-900 py-20 scroll-mt-20 select-none">
        <div className="max-w-7xl mx-auto px-6 space-y-8">
          <div className="text-center">
            <span className="text-xs font-mono font-bold text-yellow-400 uppercase tracking-widest block">PORTFOLIO // GLOBAL PARTNERS</span>
      ...
      <section id="contact" className="relative bg-slate-950 py-24 border-t border-slate-900 overflow-hidden scroll-mt-20">
        <div className="absolute top-0 right-0 w-[40%] h-full bg-yellow-400/5 transform skew-x-12 z-0 hidden lg:block border-l border-yellow-400/10 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-yellow-400/10 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-4 space-y-8">
              <div className="relative bg-gradient-to-br from-yellow-400 to-amber-500 rounded-3xl p-8 shadow-2xl overflow-hidden text-slate-950 border border-yellow-300">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="relative w-64 h-20 -ml-2 drop-shadow-[0_0_15px_rgba(245,158,11,0.2)]">
                    <img src="/truckgear-typo-logo.png" alt="TruckGear" className="w-full h-full object-contain object-left" />
                  </div>
              ...
              <div className="flex flex-col gap-4 mt-6">
                ...
                <Link 
                  href="/catalog"
                  className="w-full flex items-center justify-center gap-3 bg-yellow-400 hover:bg-yellow-300 text-slate-950 py-4 px-6 rounded-xl font-bold transition-all hover:scale-[1.02] shadow-lg shadow-yellow-400/20"
                >
              ...
              <div className="space-y-6 text-slate-300 font-mono text-xs hidden lg:block bg-slate-900/40 p-6 rounded-2xl border border-slate-800 shadow-lg">
                <div className="flex items-center gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-yellow-400 text-slate-950 flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform">
            ...
            {/* Right Column: Branch Directory with Staff Contacts & Google Maps */}
            <div className="lg:col-span-8">
              <div className="mb-8 flex items-center justify-between border-b border-slate-800 pb-4">
                ...
                <span className="text-[10px] text-yellow-400 uppercase tracking-widest font-mono font-bold bg-yellow-400/10 px-3 py-1 rounded-full border border-yellow-400/20">6 Locations</span>
              </div>
              
              <div className="grid sm:grid-cols-2 gap-4">
                {/* Branch 1 */}
                <div className="bg-slate-900/50 border border-slate-800 hover:border-yellow-400/40 p-5 rounded-2xl transition-all group flex flex-col">
                  <h4 className="font-bold text-yellow-400 text-sm mb-2 uppercase tracking-wide">TRUCKGEAR TRUCK PARTS STORE</h4>
                  ...
                  <div className="space-y-1 font-mono text-[10px] text-slate-300 bg-slate-950 p-3 rounded-lg border border-slate-800/60 mt-auto mb-4">
                    ...
                    <div className="flex justify-between"><span className="text-slate-500">Benny:</span> <span>0935 881 8350</span></div>
                  </div>
                ...
                {/* Branch 2 */}
                <div className="bg-slate-900/50 border border-slate-800 hover:border-yellow-400/40 p-5 rounded-2xl transition-all group flex flex-col">
                  <h4 className="font-bold text-yellow-400 text-sm mb-2 uppercase tracking-wide">TRUCKGEAR MOTORPARTS CENTER</h4>
                  <div className="flex gap-2 items-start text-xs text-slate-400 mb-3">
                    <MapPin className="w-3.5 h-3.5 text-slate-500 shrink-0 mt-0.5" />
          ...
          <div className="flex justify-center items-center gap-3 text-slate-400">
            ...
            <div className="flex flex-col text-left select-none">
              <span className="font-black italic text-xs tracking-wide text-white leading-none">
                Truck<span className="text-yellow-400">Gear</span>
              </span>
              <span className="text-[8px] font-mono text-slate-500 uppercase tracking-widest leading-none mt-0.5">PHILIPPINES CO.</span>
            </div>
          </div>

          <p className="text-[10px] text-slate-500 pt-4">© 2026 TruckGear Philippines Co. All rights reserved.</p>
        </div>
      </footer>
